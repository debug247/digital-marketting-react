    ...
    return (
        <>
            <section className='w-full bg-black m-auto grid lg:grid-cols-3 grid-cols-1 justify-between items-start lg:gap-28 gap-16 lg:p-20 p-10'>
                ...
                <div className='flex flex-col justify-center items-start gap-10'>
                    ...
                    <div className='flex flex-col justify-center items-start gap-4'>
                        <p className='flex justify-center items-center gap-3'><FaMapMarkedAlt className='text-limegreen size-8' /> <span className='text-[16px] font-ubuntu text-slate-100'>374 William S Canning Blvd, Fall River MA 2721, USA</span></p>
                        <p className='flex justify-center items-center gap-3'><FaPhoneVolume className='text-limegreen size-6' /><span className='text-[16px] font-ubuntu text-slate-100'>+880 155-69569</span></p>
                        <p className='flex justify-center items-center gap-3'><IoIosMailOpen className='text-limegreen size-6' /><span className='text-[16px] font-ubuntu text-slate-100'>support@rstheme.com</span></p>
                ...
                <div className='flex flex-col justify-center items-start gap-6'>
                    ...
                    <p className='text-[16px] font-ubuntu text-slate-100'>The charms of pleasure of the pulesser empect moment by desire.</p>
            ...
            <section className='w-full bg-black m-auto border-y-2 border-slate-600 grid lg:grid-cols-3 grid-cols-1 justify-between items-center lg:gap-28 gap-8 py-6 px-20'>
                <div><h1 className='text-white text-[17px] font-ubuntu text-center'>Copyright © 2024, Web Pulse, All Rights Reserved</h1></div>
                <div><p className='text-white text-3xl text-center font-ubuntu font-bold'>Web<span className='text-limegreen italic'>Pulse</span></p></div>

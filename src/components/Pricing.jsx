...
const Pricing = () => {
    ...
    return (
        <section id='plans' className='w-[90%] m-auto flex flex-col justify-between items-center gap-2 py-20 sm-px-20'>
            <h1 data-aos="zoom-in" data-aos-delay="200" className=' text-lime-500 font-ubuntu text-[19px] font-semibold'>PRICING PLAN</h1>
            ...
            <div data-aos="zoom-in" data-aos-delay="600" className='w-full flex lg:flex-row flex-col justify-between items-center gap-10 mt-10'>
                {
                    pricingplan.map((item, index) => (
                        <div key={index} className='bg-black p-10 rounded-3xl flex flex-col justify-center items-start gap-4 lg:w-[35%] w-full'>

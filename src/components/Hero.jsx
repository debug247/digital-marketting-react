...
const Hero = () => {
    ...
    return (
        <section id='hero' className='w-[90%] m-auto flex lg:flex-row flex-col justify-between items-center gap-28 py-20 sm-px-20'>
            <div className='flex flex-col justify-center items-start gap-8'><h1 data-aos="zoom-in" data-aos-delay="" className='text-black font-semibold lg:text-[90px] text-[65px] lg:leading-[100px] leading-[80px] font-ubuntu'>Social Media Marketting</h1>
                <p data-aos="zoom-in" data-aos-delay="400" className='font-ubuntu text-[20px] text-slate-700'>We design exceptional brands, products, web apps, mobile apps,<br></br> websites for startups and enterprises.</p>
            ...
            <div>
                <img data-aos="zoom-in" data-aos-delay="1000" src={herobanner} alt="" className='lg:w-[750px] lg:h-[550px]' />
            </div>
        </section>
    )
}
